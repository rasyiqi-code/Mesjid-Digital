...
import { FileText, Calendar, Database, Eye, Download, Table, Share2 } from 'lucide-react';
...
export const ReportGenerator: React.FC<ReportGeneratorProps> = ({ showToast }) => {
  ...
  const handleExportPDF = () => {
    exportToPDF(reportType, reportData, selectedMonth, selectedYear, months, formatRupiah, showToast);
  };

  const handleExportCSV = () => {
    exportToCSV(reportType, reportData, selectedMonth, selectedYear, showToast);
  };
