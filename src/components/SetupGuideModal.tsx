  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Konten Dokumentasi */}
        <div className="documentation-body" style={{ textAlign: 'left', display: 'flex', flexDirection: 'column', gap: '1.25rem', fontSize: '0.85rem', color: 'var(--text-primary)', paddingRight: '0.25rem' }}>
          ...
          <div>
            <h4 style={{ fontWeight: 800, marginBottom: '0.5rem', color: 'var(--text-primary)' }}>Langkah Setup (Hanya Sekali)</h4>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.75rem' }}>
                ...
                <tbody>
                  <tr style={{ borderBottom: '1px solid rgba(0,0,0,0.03)' }}>
                    <td style={{ padding: '0.45rem', fontWeight: 700, color: 'var(--danger)' }}>"Token tidak valid"</td>
                  ...
                  <tr style={{ borderBottom: '1px solid rgba(0,0,0,0.03)' }}>
                    <td style={{ padding: '0.45rem', fontWeight: 700, color: 'var(--danger)' }}>"Spreadsheet belum di-setup"</td>
                  ...
                  <tr style={{ borderBottom: '1px solid rgba(0,0,0,0.03)' }}>
                    <td style={{ padding: '0.45rem', fontWeight: 700, color: 'var(--danger)' }}>Koneksi timeout / Lambat</td>
